...
@section('title', 'Profile | Admin HMD')
          ...
          <section class="row g-3">
            <div class="col-12 col-xl-4">
              <div class="panel h-100 text-center profile-card">
                ...
                <img class="avatar-img avatar-xl profile-photo" src="../assets/images/avatar/avatar.jpg" alt="Admin Vishal">
                <h2 class="h5 mt-3 mb-1">Admin Vishal</h2>
